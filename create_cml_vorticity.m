...
line37=['				<shadingVariable value =  4></shadingVariable>\n'];

line38=['				<!-- -minMaxValue < value < +minMaxValue -->\n'];
line39=['				<colormap auto = false min = ' num2str(-0.1) ' max = ' num2str(0.1) '></colormap>\n'];
line40=['			    <drylandDepthOfInundation auto = true show = true value = 0.1 max = 1></drylandDepthOfInundation>\n'];
line41=['			    <dissipationIntensity show = true threshold = ' num2str(brk1) ' decay = ' num2str(0.3) '></dissipationIntensity>\n'];
